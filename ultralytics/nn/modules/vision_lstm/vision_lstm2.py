...
class ViLLayer(nn.Module):
    ...
    def _ffn_residual(self, x_in: torch.Tensor) -> torch.Tensor:
        """Post-MLP / channel-mixing residual path."""
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        """
        Expected input layout: NHWC, i.e. (B, H, W, C).
        """
